...
class BinaryFile:
    def __init__(self, filename, record, blocking_factor, empty_record):
        ...
        self.empty_key = empty_record.get("id")
    ...
    def read_block(self, file):
        ...
        ):  # slajsingom izdvajamo niz bita za svaki slog, i potom vrsimo otpakivanje
